...
public class ContactView extends JFrame {
    ...
    public ContactView(ContactController controller) {
        ...
        UIManager.put("TableHeader.font", new Font("Segoe UI", Font.BOLD, 17));
    ...
    private void showWelcomeMessage() {
        JDialog welcomeDialog = new JDialog(this, "Bienvenida", true);
        ...
        JLabel title = new JLabel("📒 Bienvenido a tu Agenda MVC Swing", JLabel.CENTER);
        title.setFont(new Font("Segoe UI", Font.BOLD, 22));
        title.setForeground(new Color(0, 123, 255));

        JLabel message = new JLabel("<html><div style='text-align:center;'>Gestiona tus contactos de manera<br>fácil, rápida y con estilo moderno.</div></html>", JLabel.CENTER);
        ...
        startBtn.addActionListener(e -> welcomeDialog.dispose());
        ...
        welcomeDialog.add(btnPanel, BorderLayout.SOUTH);
